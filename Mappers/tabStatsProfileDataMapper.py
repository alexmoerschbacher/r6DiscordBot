...
class TabStatsProfileDataMapper:
    def tabStatsProfileDataStatsMapper(profileData, username):
        ...
        return PlayerStats(profileId, None, None, None, None, profileData["wins"], profileData["losses"], None, None, profileData["kills"], None, profileData["deaths"], profileData["kd"], username)